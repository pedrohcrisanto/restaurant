...
ActiveRecord::Schema[8.0].define(version: 2025_10_29_120060) do
  ...
  create_table "menu_item_placements", force: :cascade do |t|
    ...
    t.index ["menu_id", "menu_item_id"], name: "index_menu_item_placements_on_menu_and_item", unique: true
  ...
  create_table "menus", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "restaurant_id, lower((name)::text)", name: "index_menus_on_restaurant_id_and_lower_name", unique: true
  ...
  create_table "restaurants", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "lower((name)::text)", name: "index_restaurants_on_lower_name", unique: true
